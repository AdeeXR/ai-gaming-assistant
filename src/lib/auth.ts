// src/lib/auth.ts
// This file defines the NextAuth.js configuration options.
// It is separated from the API route handler to allow it to be imported
// by other server-side files (like API routes) for getServerSession.
...
// Define the NextAuth.js options and EXPORT them from here
export const authOptions: AuthOptions = { // <--- EXPORTED FROM THIS FILE
  providers: [
    CredentialsProvider({
      name: 'Credentials',
      credentials: {
